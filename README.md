...
### ۵. پایگاه داده کلان تاریخ NBER (NBER Macrohistory Database)
...
### ۱۴. اطلس پیچیدگی اقتصادی هاروارد (Atlas of Economic Complexity - AEC)
...
## دیتابیس‌های پیچیدگی اجتماعی و کلان‌تاریخ
...
### ‏۲۰. IPUMS - سری‌ داده‌های خرد یکپارچه برای استفاده عمومی
